...
export default function ProfileScreen() {
  ...
  async function handlePickAvatar() {
    ...
    // ponytail: images-only picker uses PHPickerViewController on iOS, which
    // needs no library permission at all — see docs.expo.dev/versions/latest/sdk/imagepicker
